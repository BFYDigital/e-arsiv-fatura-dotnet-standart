### Bu paket [Fatih Kadir Akın](https://github.com/f)'ın hazırlamış olduğu [fatura](https://github.com/f/fatura) paketinin C# dili .NET Framework 4.8 ile yazılmış versiyonudur.
